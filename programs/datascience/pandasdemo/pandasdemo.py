...
print('Reading data from csv ',dfnew)


print('To dataframe to a excel')
df.to_excel('data.xlsx')

dfnewxl = pd.read_excel('data.xlsx')
print('Reading data from excel ',dfnewxl)


data1 = {'Country':["India","China","Japan"],'Capital':["Delhi","Beijing","Tokio"],'Population':[7,30,5]}
print('data ',data1)    
df1 = pd.DataFrame(data1,index=['I','C','J'])
print('df1 ',df1)
